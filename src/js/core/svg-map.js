...
export default class svgMap {
  ...
  mapPaths = {
    ...
    'PS': {
      d: 'M1166.9,366.1l-2-0.9l-0.7,4.3l1.4,0.7l-1.2,0.8l-0.1,1.7l2.4-0.8l0.6-1.9L1166.9,366.1L1166.9,366.1z M1161.2478,374.65417l-0.6228,-1.02917l1.5,-2.75l0.75,0.875l-0.5,1.25l0,0.875l-1.1272,0.77917z'
    },
    'PA': {
